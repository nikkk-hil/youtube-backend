...
*/
    ...
    const {accessToken, refreshToken} = generateAccessAndReference(existedUser._id);

    const loggedInUser = User.findById(refreshToken._id).select("-password -refreshToken");
